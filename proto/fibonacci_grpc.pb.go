...
type FibonacciServiceClient interface {
	GetFibonacciSlice(ctx context.Context, in *GetFibonacciSliceReq, opts ...grpc.CallOption) (*GetFibonacciSliceRes, error)
}
...
func (c *fibonacciServiceClient) GetFibonacciSlice(ctx context.Context, in *GetFibonacciSliceReq, opts ...grpc.CallOption) (*GetFibonacciSliceRes, error) {
	out := new(GetFibonacciSliceRes)
	err := c.cc.Invoke(ctx, "/proto.FibonacciService/GetFibonacciSlice", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FibonacciServiceServer interface {
	GetFibonacciSlice(context.Context, *GetFibonacciSliceReq) (*GetFibonacciSliceRes, error)
}
...
func (UnimplementedFibonacciServiceServer) GetFibonacciSlice(context.Context, *GetFibonacciSliceReq) (*GetFibonacciSliceRes, error) {
...
func _FibonacciService_GetFibonacciSlice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetFibonacciSliceReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FibonacciServiceServer).GetFibonacciSlice(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.FibonacciService/GetFibonacciSlice",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FibonacciServiceServer).GetFibonacciSlice(ctx, req.(*GetFibonacciSliceReq))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _FibonacciService_GetFibonacciSlice_Handler,
		},
	},
